<template>
  <div class="layout">
    ...
    <div class="topbar-wrapper" :style="{left: this.isCollapsed?'64px':'200px'}">
      ...
      <div class="title float-left">Moutain-Bank 后台管理员系统</div>
        ...
        <li v-if="user" class="menu-item" style="padding: 0;">
          <el-dropdown
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="c">{{user.type.name}}</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </li>
        <li class="menu-item">
      ...
      return {
        sider_menu_data: [
          ...
          },
          {
            ...
            children: [
              {path: '/tables/basic', title: '存款员工'},
              {path: '/tables/sort', title: '贷款员工'},
              {path: '/tables/filter', title: '理财员工'}
            ]
          },
          {
            path: '/charts',
          ...
          },
          {
            ...
            children: [
              {path: '/form/render', title: '考勤系统'},
              {path: '/form/render_select', title: '个人考勤查看'}
            ]
          },
          // {
          //   path: '/system/index',
          ...
          //   children: [
          //     {path: '/system/index', title: '添加任务'},
          //     {path: '/system/mession', title: '任务列表'}
          //   ]
          // },
          {
            path: '/user/index',
